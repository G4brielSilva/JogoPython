        ...
        if(player.Weapon.habilitColdown==0):
            if (weapon=="Sword" and choice=="b"):
                ...
                if(damage!=0):
                    ...
                    print("The enemy break the enemy's shield but no cause damage\n")
            elif(weapon=="Spear" and choice=="w"):
                damage=player.Weapon.Weakness(enemy,player)
